"""blink run — execute tasks defined in ~/.blink/loop/tasks.yaml."""
...
from blink.loop.task import run_task


def add_parser(subparsers):
    p = subparsers.add_parser("run", help="Run tasks defined in ~/.blink/loop/tasks.yaml")
